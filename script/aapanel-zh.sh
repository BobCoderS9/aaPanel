...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://ghproxy.com/https://github.com/BobCoderS9/aapanel/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "下载完成,正在降级."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://ghproxy.com/https://raw.githubusercontent.com/BobCoderS9/aapanel/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://ghproxy.com/https://github.com/BobCoderS9/aaPanel/releases/download/1.3/LinuxPanel-7.7.0.zip"
blue "下载完成,正在降级."
...
wget https://ghproxy.com/https://raw.githubusercontent.com/BobCoderS9/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
red "开心成功."
}
...
wget -O /root/chinese.zip https://ghproxy.com/https://github.com/BobCoderS9/aaPanel/releases/download/1.2/aapanel_chinese-6.8.21.zip
...
function start_menu(){
    ...
    purple " https://github.com/BobCoderS9/aaPanel"
    yellow " ————————————————————————————————————————————————"
