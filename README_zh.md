...
### 国外VPS
~~~
wget https://raw.githubusercontent.com/BobCoderS9/aaPanel/main/script/aapanel.sh  -O aapanel.sh && chmod +x aapanel.sh && clear && ./aapanel.sh
~~~
### 国内VPS
~~~
wget https://ghproxy.com/https://raw.githubusercontent.com/BobCoderS9/aaPanel/main/script/aapanel.sh  -O aapanel.sh && chmod +x aapanel.sh && clear && ./aapanel.sh
~~~
